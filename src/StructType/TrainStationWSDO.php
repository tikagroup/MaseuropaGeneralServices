...
/**
 * This class stands for TrainStationWSDO StructType
 * @subpackage Structs
 */
class TrainStationWSDO extends AbstractStructBase
{
    /**
     * The id
    ...
    public $city_id;
    /**
     * Constructor method for TrainStationWSDO
     * @uses TrainStationWSDO::setId()
     * @uses TrainStationWSDO::setCode_station()
     * @uses TrainStationWSDO::setName()
     * @uses TrainStationWSDO::setCountry_zone_id()
     * @uses TrainStationWSDO::setCity_id()
     * @param int $id
